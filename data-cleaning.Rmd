...
#coups missing none
#party missing Myanmar, Yemen, Bangladesh, Bolivia, Honduras, Mali, Pakistan, Thailand, Nepal, Nicaragua, Zambia, Papua New Guinea, Turkey, Ukraine, Sri Lanka, Comoros, Fiji, Serbia
...
mod2 <- lme(fixed = osi_logit ~ prior_year_party_score + prior_year_big_protest + prior_10_years_coups * prior_year_resource_rents + tti + factor(year),
            random = ~ 1 | country,
            #Figure out how many levels of autoregression to go back  - supposed to make some kind of graph
            correlation = corARMA(form = ~ year | country, p=3, q=0),
            data = all_data,
